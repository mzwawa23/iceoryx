...
function (cpptest_enable_coverage)
  ...
  set(CPPTEST_COVERAGE_TYPE_INSTRUMENTATION -line-coverage -statement-coverage -block-coverage -decision-coverage -simple-condition-coverage -mcdc-coverage -function-coverage -call-coverage -constexpr-coverage -template-coverages)
  ...
  #else()
  #  set(CMAKE_EXE_LINKER_FLAGS ${CPPTEST_LINKER_FLAGS} CACHE STRING "" FORCE)
  #endif()
